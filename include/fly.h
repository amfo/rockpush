...
void fly_move(Rock_Scroll_Map *, Rock_Sprite *);
void fly_change_direction(Rock_Sprite *);
void fly_change_orientation(Rock_Sprite *, int16_t);
void fly_to_diamonds(Rock_Scroll_Map *, Rock_Sprite *);